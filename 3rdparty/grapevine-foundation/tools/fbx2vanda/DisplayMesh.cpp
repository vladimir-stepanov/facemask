...
void DisplayControlsPoints(FbxMesh* pMesh, FBX2Vanda::Mesh* barrelMesh, Grapevine::Matrix4& transformation);
void DisplayPolygons(FbxMesh* pMesh, FBX2Vanda::Mesh* barrelMesh, Grapevine::Matrix4& rotation);
...
void DisplayMaterialConnections(FbxMesh* pMesh, Exporter& exporter, FBX2Vanda::Mesh* barrelMesh);
void DisplayMaterialTextureConnections(FbxSurfaceMaterial* pMaterial, Exporter& exporter, FBX2Vanda::Mesh* barrelMesh, char * header, int pMatId, int l );
...
{
    FBX2Vanda::Mesh* barrelMesh = new FBX2Vanda::Mesh();
...
void DisplayControlsPoints(FbxMesh* pMesh, FBX2Vanda::Mesh* barrelMesh, Grapevine::Matrix4& transformation)
{
    ...
    for (i = 0; i < lControlPointsCount; i++)
    {
        ...
        FBX2Vanda::ControlPoint* point = new FBX2Vanda::ControlPoint(i, coordinate);
...
void DisplayPolygons(FbxMesh* pMesh, FBX2Vanda::Mesh* barrelMesh, Grapevine::Matrix4& rotation)
{
    ...
    {
        FBX2Vanda::Polygon* barrelPolygon = new FBX2Vanda::Polygon();
        ...
        for (j = 0; j < lPolygonSize; j++)
        {
            ...
            FBX2Vanda::ControlPoint* barrelPoint = barrelMesh->point(lControlPointIndex);
            if (barrelPoint == NULL)
            {
...
//                        Grapevine::Log::D("UVCoordinate creation! 1");
                        barrelPoint->addUVCoordinate(new FBX2Vanda::UVCoordinate(tmp), l);
...
//                        Grapevine::Log::D("UVCoordinate creation! 2");
            ...
            FBX2Vanda::Normal* barrelNormal = new FBX2Vanda::Normal(tmp);
...
void DisplayMaterialTextureConnections(FbxSurfaceMaterial* pMaterial, Exporter& exporter, FBX2Vanda::Mesh* barrelMesh, char * header, int pMatId, int l )
{
    ...
    FBX2Vanda::Material* material = new FBX2Vanda::Material();
