...
public class LbpFaceDetector {

    private static final String TAG = "LbpFaceDetector";
    private static final Object LOCK = new Object();
    private static final String CASCADE = "Facemask/lbpcascade_frontalface.xml";
    @SuppressLint("StaticFieldLeak")
    private static LbpFaceDetector sLbpFaceDetector = null;

    static {
        try {
            System.loadLibrary("lbp_jni");
            jniNativeClassInit();
    ...
    public static LbpFaceDetector getInstance(Context context) {
        synchronized (LOCK) {
            if (sLbpFaceDetector == null) {
                sLbpFaceDetector = new LbpFaceDetector(context);
            }
            return sLbpFaceDetector;
        }
    }
